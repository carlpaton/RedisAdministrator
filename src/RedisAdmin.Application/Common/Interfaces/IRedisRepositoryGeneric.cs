...
{
    /// <summary>
    /// Generic commands to help administer the redis instance, these commands should work with any redis type.
    /// </summary>
    public interface IRedisRepositoryGeneric
    {
        /// <summary>
        ...
        /// 
        /// </summary>
        /// <param name="info">Option to filter by a specific section of information; example: MEMORY</param>
        /// <returns></returns>
        string Info(Information.Info info = Information.Info.All);
